...
XGpio_Config XGpio_ConfigTable[XPAR_XGPIO_NUM_INSTANCES] =
{
	...
	{
		XPAR_SENSOR_STREAM_0_AXI_GPIO_0_DEVICE_ID,
		XPAR_SENSOR_STREAM_0_AXI_GPIO_0_BASEADDR,
		XPAR_SENSOR_STREAM_0_AXI_GPIO_0_INTERRUPT_PRESENT,
		XPAR_SENSOR_STREAM_0_AXI_GPIO_0_IS_DUAL
	}
};
