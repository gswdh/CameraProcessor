...
/* Definitions for peripheral AXI_EVF_GPIO_1 */
#define XPAR_AXI_EVF_GPIO_1_BASEADDR 0x41210000
#define XPAR_AXI_EVF_GPIO_1_HIGHADDR 0x4121FFFF
#define XPAR_AXI_EVF_GPIO_1_DEVICE_ID 0
#define XPAR_AXI_EVF_GPIO_1_INTERRUPT_PRESENT 0
#define XPAR_AXI_EVF_GPIO_1_IS_DUAL 0


/* Definitions for peripheral AXI_SEN_GPIO_0 */
#define XPAR_AXI_SEN_GPIO_0_BASEADDR 0x41200000
#define XPAR_AXI_SEN_GPIO_0_HIGHADDR 0x4120FFFF
#define XPAR_AXI_SEN_GPIO_0_DEVICE_ID 1
#define XPAR_AXI_SEN_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_AXI_SEN_GPIO_0_IS_DUAL 1


/******************************************************************/

/* Canonical definitions for peripheral AXI_EVF_GPIO_1 */
#define XPAR_GPIO_0_BASEADDR 0x41210000
#define XPAR_GPIO_0_HIGHADDR 0x4121FFFF
#define XPAR_GPIO_0_DEVICE_ID XPAR_AXI_EVF_GPIO_1_DEVICE_ID
#define XPAR_GPIO_0_INTERRUPT_PRESENT 0
#define XPAR_GPIO_0_IS_DUAL 0

/* Canonical definitions for peripheral AXI_SEN_GPIO_0 */
#define XPAR_GPIO_1_BASEADDR 0x41200000
#define XPAR_GPIO_1_HIGHADDR 0x4120FFFF
#define XPAR_GPIO_1_DEVICE_ID XPAR_AXI_SEN_GPIO_0_DEVICE_ID
